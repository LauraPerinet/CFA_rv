...
if($annonce->autonomy==1){
  $type="<p style='margin-bottom:20px;> Merci de nous indiquer si vous êtes interessé(e) par cette offre. Nous nous occupons de transferer les CVs. </p>";
}else{
  $type="<p style='margin-bottom:20px;> Si vous êtes interessé(e), envoyez CV et lettre de motivation au contact indiqué, et n'oubliez pas de nous en tenir informé.</p>";
}
...
Merci de nous indiquer si vous êtes interessé(e) par cette offre. ".$type."\n
...
<p>Elle sera disponible jusqu'au <b>".$day."</b></p>".$type."
